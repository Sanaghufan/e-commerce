...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Furniture Co.", label: "Furniture Co.", checked: true },
    ],
  },
];
        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {/* Section of product and filters */}
...
function Pagination({ page, setPage, handlePage, totalItems }){
  return (<> <div className="flex flex-1 justify-between sm:hidden">
    <a
      href="#"
  ...
  <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
    <div>
      ...
      Showing{' '}  <span className="font-medium">
            ...
            of <span className="font-medium">{totalItems}</span> results </p>
    </div>
    <div>
      <nav
              ...
              >
                ...
                <div className="mt-4 flex justify-between">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium line-through block text-gray-900">
                      {product.price}
                    </p>
                  </div>
                </div>
